...
document.querySelector(".favorite-picture") && document.addEventListener("DOMContentLoaded", function () {
    ...
    let checkboxes = [];
    function initFavoritePicture(){
        checkboxes = document.querySelectorAll(".favorite-picture");
    ...
    // When insertData() is called, reinitialise the checkboxes
    $(document).on('initFavoritePicture', function() { initFavoritePicture();});
});
...
document.querySelector(".photoToDelete") && document.addEventListener("DOMContentLoaded", function () {
    ...
    initPhotoToDelete();
    // When insertData() is called, reinitialise the checkboxes
    $(document).on('initFavoritePicture', function() { initPhotoToDelete();});
});