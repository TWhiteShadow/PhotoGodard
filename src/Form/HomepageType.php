...
class HomepageType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('descriptionText', TextareaType::class, ['label' => 'Texte de description', 'attr' => ['placeholder' => 'ex: Artiste français passionné de ...']])
            ->add('contactDescription', TextareaType::class, ['label' => 'Texte de contact', 'attr' => ['placeholder' => 'ex: Vous pouvez me contacter...']])
